...
We introduced a symbolic music generator with non-differentiable rule guided diffusion models,  drawing inspiration from stochastic control. Please check [here](https://drive.google.com/drive/folders/1HHJ-TVhC4O9bnIKWvSC7cGq6PQ8UqrDu?usp=share_link) for the mp3 and midi files of the generated music. We released a [colab notebook](https://colab.research.google.com/drive/1UDXQMsypHT_I2HcbYnWna3tFwuFlQEw8?usp=sharing) for demonstration.  For more music demos, please visit our [project website](https://scg-rule-guided-music.github.io/).
